  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        free: "border-transparent bg-tier-free/20 text-tier-free",
        pro: "border-transparent bg-tier-pro/20 text-tier-pro",
        premium: "border-transparent bg-tier-premium/20 text-tier-premium",
